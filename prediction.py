...
if __name__ == "__main__":
	...
	parser.add_argument('--model_path', type=str, default='./models/weights.comb.npz') #所以路径与当前路径有关
	parser.add_argument('--video_path', type=str)		  #增加两个属性
	args = parser.parse_args()
	predict(args.model_path, args.video_path)		  #得到两个属性，分别传入函数
