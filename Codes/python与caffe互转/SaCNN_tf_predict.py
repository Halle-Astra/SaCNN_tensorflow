...
from src.sacnn import build
import time
from matplotlib import pyplot as plt 
from PIL import Image

VGG_MEAN = [103.939, 116.779, 123.68]
base_model_path = ‘./logs/session-133/training_logging/weights.24.1.npy’
...
if __name__ == "__main__":    
    ...
    with G.as_default():
        ...
        d_map_est,net_mid = build(image_place_holder)      
       	utils.load_weights(G,base_model_path)
